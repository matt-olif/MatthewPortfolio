...
Special annimantions to add:

Social Media utton: CSS CODE (button {
  height: 4em;
  width: 15em;
  border: none;
  border-radius: 40px;
...
HTML Code (<!-- From Uiverse.io by gagan-gv --> 
<button>
  <span>Share</span>
  <div class="container">
    <svg
...
COURSE MODULES HOVER ANNMATION FOR SHORT DESCRIPTION: (
